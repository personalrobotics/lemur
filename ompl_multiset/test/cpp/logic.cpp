...
{
   ompl_multiset::LogicEngine logic(1);
   logic.initialize();
   
   ompl_multiset::LogicEngine::Assignment a = logic.empty_assignment();
   ompl_multiset::LogicEngine::VarVal target;
   std::vector<double> costs;
   costs.push_back(1.0);
   
   std::vector<ompl_multiset::LogicEngine::AssignmentDelta> deltas;
...
{
   ompl_multiset::LogicEngine logic(2);

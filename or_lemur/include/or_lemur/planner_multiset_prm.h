...
public:
   ...
   boost::weak_ptr<or_lemur::ModuleSubsetManager> subset_manager;
   boost::shared_ptr<or_lemur::ModuleSubsetManager> private_subset_manager;
   ...
   boost::shared_ptr<ompl_lemur::MultiSetPRM> ompl_planner;

...
#include <ompl_lemur/MultiSetRoadmapSampledConst.h>
...
or_lemur::MultiSetPRM::PlannerParameters::PlannerParameters():
...
void or_lemur::MultiSetPRM::PlannerParameters::serialize_eval_subgraphs(std::ostream & sout) const
{
   sout << "<eval_subgraphs>";
...
void or_lemur::MultiSetPRM::PlannerParameters::serialize_lambda(std::ostream& sout) const
{
   sout << "<lambda>";
   sout << this->lambda;
   sout << "</lambda>";
...
void or_lemur::MultiSetPRM::PlannerParameters::serialize_interroot_radius(std::ostream& sout) const
{
...
void or_lemur::MultiSetPRM::PlannerParameters::serialize_timelimit(std::ostream& sout) const
{
   sout << "<timelimit>";
   sout << this->timelimit;
   sout << "</timelimit>";
...
void or_lemur::MultiSetPRM::PlannerParameters::deserialize_eval_subgraphs(std::istream & sin)
{
   sin >> this->eval_subgraphs;
}

void or_lemur::MultiSetPRM::PlannerParameters::deserialize_lambda(std::istream & sin)
{
   sin >> this->lambda;
}

void or_lemur::MultiSetPRM::PlannerParameters::deserialize_interroot_radius(std::istream & sin)
{
   sin >> this->interroot_radius;
}

void or_lemur::MultiSetPRM::PlannerParameters::deserialize_timelimit(std::istream & sin)
{
   sin >> this->timelimit;
}

bool or_lemur::MultiSetPRM::PlannerParameters::serialize(std::ostream& sout, int options) const
{
...
OpenRAVE::BaseXMLReader::ProcessElement or_lemur::MultiSetPRM::PlannerParameters::startElement(
...
bool or_lemur::MultiSetPRM::PlannerParameters::endElement(const std::string & name)
{
   if (!el_deserializing.size())
...
or_lemur::MultiSetPRM::MultiSetPRM(OpenRAVE::EnvironmentBasePtr penv):
   ...
   roadmap_string("class=MultiSetRoadmapSampledConst seed=419884521 batch_n=1000 radius=2")
{
   ...
   this->RegisterCommand("UseSubsetManager",
      boost::bind(&or_lemur::MultiSetPRM::UseSubsetManager,this,_1,_2),
      "UseSubsetManager");
   this->RegisterCommand("SetRoadmap",
      boost::bind(&or_lemur::MultiSetPRM::SetRoadmap,this,_1,_2),
      "SetRoadmap");
   this->RegisterCommand("GetTimes",
      boost::bind(&or_lemur::MultiSetPRM::GetTimes,this,_1,_2),
      "GetTimes");
   this->RegisterCommand("GetNumSubgraphsUsed",
      boost::bind(&or_lemur::MultiSetPRM::GetNumSubgraphsUsed,this,_1,_2),
      "GetNumSubgraphsUsed");
   this->RegisterCommand("CacheSetLocation",
      boost::bind(&or_lemur::MultiSetPRM::CacheSetLocation,this,_1,_2),
      "CacheSetLocation");
   this->RegisterCommand("CacheLoad",
      boost::bind(&or_lemur::MultiSetPRM::CacheLoad,this,_1,_2),
      "CacheLoad");
   this->RegisterCommand("CacheSave",
      boost::bind(&or_lemur::MultiSetPRM::CacheSave,this,_1,_2),
      "CacheSave");
}

or_lemur::MultiSetPRM::~MultiSetPRM()
{
}

bool or_lemur::MultiSetPRM::InitPlan(OpenRAVE::RobotBasePtr robot, std::istream & sin)
{
...
bool or_lemur::MultiSetPRM::InitPlan(OpenRAVE::RobotBasePtr robot, OpenRAVE::PlannerBase::PlannerParametersConstPtr params)
{
   // is this one of ours?
...
bool or_lemur::MultiSetPRM::InitMyPlan(OpenRAVE::RobotBasePtr robot, PlannerParametersConstPtr params)
{   
...
OpenRAVE::PlannerBase::PlannerParametersConstPtr or_lemur::MultiSetPRM::GetParameters() const
{
   return this->params;
}

std::string or_lemur::MultiSetPRM::update_planner_current_subsets(
   OpenRAVE::RobotBasePtr robot)
{
   // get subset manager (will construct private if not attached)
   boost::shared_ptr<or_lemur::ModuleSubsetManager> ssm = this->get_subset_manager();
   if (!ssm)
   ...
   for (unsigned int si=0; si<report.subsets.size(); si++)
   {
      if (this->subsets.find(report.subsets[si].name) == this->subsets.end())
      {
         ...
         space_info->setStateValidityChecker(boost::bind(
            &or_lemur::MultiSetPRM::ompl_isvalid, this,
   ...
   {
      or_lemur::SubsetReport::Intersection & isec
...
OpenRAVE::PlannerStatus or_lemur::MultiSetPRM::PlanPath(OpenRAVE::TrajectoryBasePtr ptraj)
{
...
bool or_lemur::MultiSetPRM::UseSubsetManager(std::ostream & sout, std::istream & sin)
{
   // parse args
...
bool or_lemur::MultiSetPRM::SetRoadmap(std::ostream & sout, std::istream & sin)
{
...
bool or_lemur::MultiSetPRM::CacheSetLocation(std::ostream & sout, std::istream & sin)
{
   // parse args
   std::vector<std::string> args = args_from_sin(sin);
   if (args.size() != 1)
   ...
   this->cache.reset(ompl_lemur::cache_create(location));
   return true;
}

bool or_lemur::MultiSetPRM::CacheLoad(std::ostream & sout, std::istream & sin)
{
   // parse args
   std::vector<std::string> args = args_from_sin(sin);
   if (args.size() != 1)
...
bool or_lemur::MultiSetPRM::CacheSave(std::ostream & sout, std::istream & sin)
{
   if (!this->ompl_planner)
...
bool or_lemur::MultiSetPRM::GetTimes(std::ostream & sout, std::istream & sin)
{
...
bool or_lemur::MultiSetPRM::GetNumSubgraphsUsed(std::ostream & sout, std::istream & sin)
{
   if (!this->ompl_planner)
...
or_lemur::MultiSetPRM::get_subset_manager()
{
   boost::shared_ptr<or_lemur::ModuleSubsetManager> ssm = this->subset_manager.lock();
   if (ssm)
      return ssm;
   ...
   this->private_subset_manager = boost::dynamic_pointer_cast<or_lemur::ModuleSubsetManager>(mod);
   this->subset_manager = this->private_subset_manager;
   return this->private_subset_manager;
}

ompl::base::RealVectorBounds or_lemur::MultiSetPRM::ompl_bounds(OpenRAVE::RobotBasePtr robot)
{
...
void or_lemur::MultiSetPRM::setup(OpenRAVE::RobotBasePtr robot)
{
   this->robot = robot;
   ...
   ompl_lemur::MultiSetRoadmapPtr roadmap;
   // class=MultiSetRoadmapSampledConst seed=419884521 batch_n=1000 radius=2
   {
      ...
      if (args[0] == "class=MultiSetRoadmapSampledConst")
      {
         ...
         roadmap.reset(new ompl_lemur::MultiSetRoadmapSampledConst(this->ompl_space, seed, batch_n, radius));
      }
      else if (args[0] == "class=MultiSetRoadmapSampledDensified")
      {
         ...
         roadmap.reset(new ompl_lemur::MultiSetRoadmapSampledDensified(this->ompl_space, seed, batch_n, gamma_rel));
      }
      else
   ...
   this->ompl_planner.reset(ompl_lemur::MultiSetPRM::create(
...
bool or_lemur::MultiSetPRM::setup_isvalid(OpenRAVE::RobotBasePtr robot)
{
   // check robot
...
bool or_lemur::MultiSetPRM::ompl_isvalid(

...
int main(int argc, char * argv[])
{
   ...
   ompl_lemur::MultiSetRoadmapPtr roadmap(
      new ompl_lemur::MultiSetRoadmapSampledConst(space, 419884521, 1000, 2.0));
   ompl_lemur::CachePtr cache;
   // cache.reset(ompl_lemur::cache_create("mycache"));
   ompl_lemur::MultiSetPRM * p
      = ompl_lemur::MultiSetPRM::create(space, roadmap);

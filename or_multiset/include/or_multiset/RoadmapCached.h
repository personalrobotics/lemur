...
class RoadmapCached : public ompl_multiset::Roadmap<RoadmapArgs>
{
   ...
   // on construction
   const boost::shared_ptr< ompl_multiset::Roadmap<RoadmapArgs> > _roadmap_wrapped;
   unsigned int _dim;
...
public:
   RoadmapCached(RoadmapArgs & args,
         boost::shared_ptr< ompl_multiset::Roadmap<RoadmapArgs> > roadmap_wrapped):
      ompl_multiset::Roadmap<RoadmapArgs>(args,
   ...
   void initialize()
   {
      ...
      std::string id = "space_id " + ompl_multiset::space_id(this->space)
         + " roadmap_id " + ompl_multiset::roadmap_id(_roadmap_wrapped.get());
...
{
public:
   boost::function<ompl_multiset::Roadmap<RoadmapArgs> * (RoadmapArgs args)> _factory;
   
   RoadmapCachedFactory(
      boost::function<ompl_multiset::Roadmap<RoadmapArgs> * (RoadmapArgs args)> factory):
      _factory(factory)
   {
   }
   ...
   {
      boost::shared_ptr< ompl_multiset::Roadmap<RoadmapArgs> > roadmap_wrapped(_factory(args));

...
using namespace ompl_lemur::util; // for sf, volume_n_ball

ompl_lemur::MultiSetRoadmapSampledConst::MultiSetRoadmapSampledConst(
...
std::string ompl_lemur::MultiSetRoadmapSampledConst::get_id()
{
   return this->id;
}

void ompl_lemur::MultiSetRoadmapSampledConst::subgraphs_limit(
   unsigned int * num_subgraphs)
{
   *num_subgraphs = 0; // no limit
}

void ompl_lemur::MultiSetRoadmapSampledConst::subgraphs_generate(
   unsigned int num_subgraphs)
{
...
void ompl_lemur::MultiSetRoadmapSampledConst::generator_save(
   std::string & data)
{
   std::stringstream ss;
...
void ompl_lemur::MultiSetRoadmapSampledConst::generator_load(
   std::string & data)
{
